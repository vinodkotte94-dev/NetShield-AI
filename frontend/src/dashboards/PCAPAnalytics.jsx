    ...
    <div className="pcap-analytics-page">
      ...
      {aiPrediction && (
        <div className="ai-results-section">
          ...
          <div className="section-title">
            <h2>ðŸ¤– AI Threat Detection Results</h2>
      ...
      {selectedAnalysis && (
        <div className="analysis-details-card">
          ...
          <div className="section-title">
            <h2>ðŸ“¡ PCAP Traffic Analysis</h2>
          ...
          {selectedAnalysis.protocol_distribution && (
            <div className="protocol-section">
              ...
              <h3>ðŸ”Œ Protocol Distribution</h3>
      ...
      <div className="previous-analyses-card">
        ...
        <div className="section-title">
          <h2>ðŸ—ƒ Previous PCAP Analyses</h2>
