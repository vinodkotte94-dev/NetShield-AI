...
def get_cic_model():
    ...
    print("Loading CICIDS2017 AI model...")
    ...
    print("Loading CIC label encoder...")

    encoder = joblib.load(
        CIC_ENCODER_PATH
    )

    print("CICIDS2017 AI model loaded.")
...
def predict_pcap_threats(file_path):
    ...
    try:
        ...
        flow_df, packet_count = extract_cic_flows(
            file_path
        )
        ...
        print(
            "PCAP AI memory cleanup completed."
        )